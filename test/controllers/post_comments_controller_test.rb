...
class PostCommentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create post_comment' do
    assert_difference('PostComment.count') do
      post post_comments_url,
           params: { post_comment: { content: @post_comment.content, parent_id: @post_comment.parent_id,
                                     post_id: @post_comment.post_id, published: @post_comment.published, published_at: @post_comment.published_at, title: @post_comment.title } }
    end
