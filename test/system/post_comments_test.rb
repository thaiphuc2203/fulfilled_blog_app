...
class PostCommentsTest < ApplicationSystemTestCase
  ...
  test 'should create post comment' do
    ...
    fill_in 'Parent', with: @post_comment.parent_id
    fill_in 'Post', with: @post_comment.post_id
    check 'Published' if @post_comment.published
    fill_in 'Published at', with: @post_comment.published_at
    fill_in 'Title', with: @post_comment.title
